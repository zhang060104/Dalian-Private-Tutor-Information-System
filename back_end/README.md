...
| `-h` | 主机 | `127.0.0.1` |
| `-P` | 端口 | `3306` |
| `--seed` | 构建后写入演示数据（3 教师 + 3 学生 + 1 管理员，密码均为 `123456`） | 关 |
...
| 角色 | 登录手机号 | 密码 | 昵称 |
|------|-----------|------|------|
| 管理员 | 13800000000 | 123456 | admin |
| 教师 | 13800000001 / 002 / 003 | 123456 | 王老师 / 李老师 / 张老师 |
| 学生 | 13900000001 / 002 / 003 | 123456 | 同学甲 / 同学乙 / 同学丙 |
