...
/**
 * 学生表 student
 * 登录：phone + password；注册/资料修改需管理员审核（requestLog type=1）
 */
@Data
public class Student {
    ...
    /** 年级：0幼儿园 1-6小学 7-9初中 10-12高中 13-16大学 17已毕业 */
    private Integer grade;
    /** 需要辅导的科目位掩码（低 24 位，见文档科目顺序） */
    private Integer subject;
    /** 个人简介 */
    private String description;
    /** 0=正在寻找老师 1=已停止寻找（status=1 不参与列表） */
    private Integer status;
    /** 周一~周日可接受家教时间位图（低 24 位 = 24 小时） */
